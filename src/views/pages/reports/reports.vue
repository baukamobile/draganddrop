...
<body>
  ...
  <div id="quality-assurance" class="panel hidden">
    <form id="form">
      ...
      <br />
      <input  type="text" placeholder="100" autocomplete="off">
      <br />
      <br />
      <p id="warning" class="hidden">
        Suitability Score must be a number
      </p><br>
      <select  class="dropdown" style="padding: 5px; border-radius: 1px; background-color: rgb(120, 240, 51);">
        <option value="">Select View</option>
        <option value="view1">user 11 bioc:stroke=\"rgb(255, 254, 252)\" bioc:fill=\"rgb(4, 255, 11)\"</option>
        <option value="view2">user 2 bioc:stroke=\"rgb(255, 254, 252)\" bioc:fill=\"rgb(4, 255, 11)\"</option>
        <option value="view3">user 3 bioc:stroke=\"rgb(255, 254, 252)\" bioc:fill=\"rgb(4, 255, 11)\"</option>
      </select>
      <br />
      <br>
      <p>
